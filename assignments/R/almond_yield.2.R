...
#' @return A list containg max, min, & mean almond yield for the anomoly equation
#' @author Ruben Sanchez Ramirez, Gabe De La Rosa, Alex Ehrens
#' @references Lobell et al. 2006

almond_yield.2 = function(climate, t.coeff1 = -0.015, t.coeff2 = -0.0046, p.coeff1 = -0.07, p.coeff2 = 0.0043, intercep = 0.28) {
